                                ...
                                <div className="absolute bottom-0 left-2/4 z-50 flex -translate-x-2/4 gap-2">
                                    {product?.images?.map((img, i) => (
                                        <Image
                                            ...
                                            className={`block my-auto cursor-pointer rounded-2xl transition-all content-[''] border-2 ${activeIndex === i
                                                ? "w-16 h-16  bg-white border-pink-300"
                                                : "w-10 h-10 bg-white/50 border-blue-gray-100"
                                                }`}
...
function ProductInfo({ info }) {
    ...
    const checkPincode = async () => {
        try {
            setError(null);
            setCity(null);
            const response = await axios.get("/api/pin-codes", {
    ...
    return (
        <div className="py-4 pr-4 max-w-[800px]">
            ...
            <div className="flex py-2">
                ...
                <button className="text-[#BC264B] text-sm mx-3 underline">
                    Add to wishlist
                </button>
            ...
            <div className="mt-2">
                ...
                <div className="flex items-center">
                    <svg
                        className="w-4 h-4 text-pink-300 me-1"
                        aria-hidden="true"
            ...
            <div className="mt-4">
                ...
                <div
                    className="bg-[#F6F6F6] p-3 rounded-md"
            ...
            <ProductFeatures />
            <div className="mt-6">
                <p className="mb-2 mt-2 text-xl font-semibold">Check your Pincode</p>
                <input
                    type="text"
                ...
                <div >
                    <button
                        className="text-[#BC264B] text-sm mt-2 mb-3 underline"
                ...
                {city && (
                    <p className="text-sm font-semibold text-green-600">
                        Delivery is available in {city}.
                    </p>
                )}
                {error && <p className="text-red-500 mt-4">{error}</p>}

                <div className="mt-2 mb-4 ">
                    <input type="checkbox" id="gift" className="rounded-none" />
                    <label htmlFor="gift" className="font-semibold text-sm mx-2">
